...
<head>
    ...
    <title>Pendaftaran KK Baru - Sistem RT</title>
    ...
    <div class="min-h-screen">
        ...
        <main class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
            <div class="mb-8">
                ...
                <h1 class="text-3xl font-extrabold text-slate-900 tracking-tight">Pendaftaran Kartu Keluarga</h1>
                <p class="text-slate-500 font-medium mt-1">Inisialisasi data keluarga sebagai basis pengelompokan warga.</p>
            </div>

            <form action="{{ route('admin.keluarga.store') }}" method="POST" class="space-y-8">
                @csrf
                ...
                <div class="bg-white rounded-[2rem] border border-slate-200/60 shadow-xl shadow-slate-200/40 p-10">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div class="space-y-2 md:col-span-2">
                            <label class="text-xs font-bold text-slate-400 uppercase tracking-widest ml-1">Nomor Kartu Keluarga (16 Digit)</label>
                            <input type="text" name="no_kk" value="{{ old('no_kk') }}" required
                                   ...
                                   placeholder="Contoh: 327101XXXXXXXXXX">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="flex items-center gap-3">
                                <input type="text" name="rt" value="{{ old('rt') }}" required placeholder="RT"
                                ...
                                <input type="text" name="rw" value="{{ old('rw') }}" required placeholder="RW"
                                       class="w-full px-5 py-4 rounded-2xl bg-slate-50 border-none ring-1 ring-slate-200 focus:ring-2 focus:ring-indigo-500 transition-all font-bold text-center">
                            </div>
                        </div>
                ...
                <div class="bg-white rounded-[2rem] border border-slate-200/60 shadow-xl shadow-slate-200/40 p-10">
                    ...
                    <div class="space-y-4">
                        ...
                        <select name="kepala_keluarga_id" class="w-full px-5 py-4 rounded-2xl bg-slate-50 border-none ring-1 ring-slate-200 focus:ring-2 focus:ring-indigo-500 transition-all font-bold appearance-none">
                            <option value="">-- Lewati (bisa ditentukan nanti) --</option>
                        ...
                        <p class="text-[11px] text-slate-400 font-medium ml-1">
                             ...
                             Pilihan ini hanya menampilkan warga yang sudah terdaftar namun belum memiliki peran Kepala Keluarga.
                        </p>
                    </div>
                </div>
