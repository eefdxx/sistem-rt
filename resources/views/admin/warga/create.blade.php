...
<body class="bg-gray-100">
    <div class="max-w-5xl mx-auto p-6">
        <div class="bg-white rounded-xl shadow p-6">
            <h1 class="text-2xl font-bold mb-6">Tambah Data Warga</h1>
            ...
            <form action="{{ route('admin.warga.store') }}" method="POST" class="space-y-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="nik" value="{{ old('nik') }}" class="w-full border rounded-lg px-3 py-2">
                        @error('nik')
                            <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="nama_lengkap" value="{{ old('nama_lengkap') }}" class="w-full border rounded-lg px-3 py-2">
                        @error('nama_lengkap')
                            <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="tempat_lahir" value="{{ old('tempat_lahir') }}" class="w-full border rounded-lg px-3 py-2">
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                        ...
                        <input type="text" name="agama" value="{{ old('agama') }}" class="w-full border rounded-lg px-3 py-2">
                    </div>

                    <div>
                        <label class="block mb-1 font-medium">Status Perkawinan</label>
                        <input type="text" name="status_perkawinan" value="{{ old('status_perkawinan') }}" class="w-full border rounded-lg px-3 py-2">
                    </div>

                    <div>
                        <label class="block mb-1 font-medium">Pekerjaan</label>
                        <input type="text" name="pekerjaan" value="{{ old('pekerjaan') }}" class="w-full border rounded-lg px-3 py-2">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div>
                        ...
                        <input type="email" name="email_pribadi" value="{{ old('email_pribadi') }}" class="w-full border rounded-lg px-3 py-2">
                    </div>

                    <div>
                        <label class="block mb-1 font-medium">Tanggal Masuk</label>
                        <input type="date" name="tanggal_masuk" value="{{ old('tanggal_masuk') }}" class="w-full border rounded-lg px-3 py-2">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="foto" value="{{ old('foto') }}" class="w-full border rounded-lg px-3 py-2">
                </div>
